...
public class Goals {
    ...
    // コンストラクタ（取得用）
    public Goals(String goalId, String goalName, String genreTag, int goalTime, int goalTimeHours, int goalTimeMins,  int progress, Timestamp goalDate, String userUuid) {
    	this.goalId = goalId;
        this.goalName = goalName;
        this.genreTag = genreTag;
        this.goalTime = goalTime;
    ...
    public String getGenreTag() {return genreTag;}
    ...
    public Timestamp getGoalDate() {return goalDate;}
    public String getUserUuid() {return userUuid;}

// セッターメソッド（必要に応じて追加）
    public void setGoal_name(String goalName) {this.goalName = goalName;}
    public void setGenreTag(String genreTag) {this.genreTag = genreTag;}
