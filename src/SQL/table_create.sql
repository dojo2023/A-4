...
　GANPARI_TIME TIMESTAMP() NOT NULL
　GOAL_ID VARCHAR() FOREIGN KEY REFERENCES GOALS(GOAL_ID)
  USER_UUID VARCHAR() FOREIGN KEY REFERENCES ACCOUNTS(USER_UUID)
　POST_TIME TIMESUTAMP() NOT NULL
...
　GOAL_TIME TIMESUTAMP() NOT NULL
  GOAL_DATE TIMESUTAMP() NOT NULL
  USER_UUID VARCHAR() FOREIGN KEY REFERENCES ACCOUNTS(USER_UUID)
);
...
　POST_ID VARCHAR() FOREIGN KEY REFERENCES POSTS(POST_ID)
  COMMENT_TIME TIMESUTAMP() NOT NULL
  USER_UUID VARCHAR() FOREIGN KEY REFERENCES ACCOUNTS(USER_UUID)
);
...
　POST_ID VARCHAR() FOREIGN KEY REFERENCES POSTS(POST_ID)
  REACTION_TIME TIMESUTAMP() NOT NULL
  USER_UUID VARCHAR() FOREIGN KEY REFERENCES ACCOUNTS(USER_UUID)
);